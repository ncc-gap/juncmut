...
def check_reference(reference):
    ...
    f = pysam.FastaFile(reference)

    grc_count, nongrc_count = 0, 0
    hg19_count, hg38_count = 0, 0

    for rname, seq_length in zip(f.references, f.lengths):
        ...
        if seq_length == hg19_dict[rname]:
            ...
            print("The length of %s is not included in either hg19 or hg38." % rname, file = sys.stderr)
    ...
    is_grc = "grc" if grc_count > nongrc_count else "ucsc"
