...
def realign_main(query, target, min_score, nMatch = 2, nMismatch = 2, nOpen = 3, nExt = 1):
    ...
    type2count = {"no_splicing_negative": 0, "no_splicing_positive": 0,
                  "target_splicing_negative": 0, "target_splicing_positive": 0,
                  "normal_splicing_negative": 0, "normal_splicing_positive": 0}
    no_splicing_positive_supporting_reads = []
    target_splicing_positive_supporting_reads = []
    ...
    for sQId,sQSeq,sQQual in read(query):
        ...
        type2max_score = {"no_splicing_negative": 0, "no_splicing_positive": 0,
                          "target_splicing_negative": 0, "target_splicing_positive": 0,
                          "normal_splicing_negative": 0, "normal_splicing_positive": 0}
        ...
        if target_max_type == "no_splicing_positive":
            no_splicing_positive_supporting_reads.append(sQId)
        elif target_max_type == "target_splicing_positive":
            target_splicing_positive_supporting_reads.append(sQId)

    return type2count, no_splicing_positive_supporting_reads, target_splicing_positive_supporting_reads
