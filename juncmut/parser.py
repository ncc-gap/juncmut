...
def create_parser():
    ...
    get.add_argument("sj_file", metavar = "sj_file", required = True, type = str, help = "Input file(such as sample.SJ.out.tab file generated by STAR)")
    get.add_argument("bam_file", metavar = "bam_file", required = True, type = str, help = "Path to RNA bam file")
    ...
    filt_bam.add_argument("input_file", metavar = "input_file", required = True, type = str, help = "juncmut.txt")
    filt_bam.add_argument("bam_file", metavar = "bam_file", required = True, type = str, help = "Path to RNA bam file")
    filt_bam.add_argument("output_file", metavar = "output_file", required = True, type = str, help = "Output bam file")
    ...
    annot.add_argument("reference", metavar = "reference", default = "", type = str, help = "Path to reference genome")
    ...
    sjclass.add_argument("input_file", metavar = "input_file", default = None, type = str, help = "Input file(such as file generated by juncmut")
    sjclass.add_argument("output_file", metavar = "output_file", default = None, type = str, help = "Output file")
    sjclass.add_argument("bam_file", metavar = "bam_file", default = None, type = str, help = "path to bam.")
    sjclass.add_argument("sj_file", metavar = "sj_file", default = None, type = str, help = "path to SJ.out.tab.gz")
    sjclass.add_argument("reference", metavar = "reference", default = None, type = str, help = "Path to reference genome")
