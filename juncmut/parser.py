...
def create_parser():
    ...
    filt.add_argument("input_file", metavar = "input_file", type = str, help = "Input file(such as juncmut.txt generated by juncmut)")
    filt.add_argument("output_file", metavar = "output_file", type = str, help = "Output file")
