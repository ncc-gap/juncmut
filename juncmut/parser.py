...
def create_parser():
    ...
    sjclass.add_argument("--bam", metavar = "bam", default = None, type = str, help = "path to bam.")
    sjclass.add_argument("--sj", metavar = "sj", default = None, type = str, help = "path to SJ.out.tab.gz")
