...
def create_parser():
    ...
    get.add_argument("-input_file", metavar = "input_file", default = None, type = str, help = "Input file(such as sample.SJ.out.tab file generated by STAR)")
    get.add_argument("-output_file", metavar = "output_file", default = "juncmut.txt", type = str, help = "Output file")
    get.add_argument("-reference", metavar = "reference", default = None, type = str, help = "Path to reference genome")
    get.add_argument("-rna_bam", metavar = "rna_bam", default = None, type = str, help = "Path to RNA bam file")
    ...
    get.add_argument("-genecode_gene_file", metavar = "genecode_gene_file", default = None, type = str, help = "Path to genecode gene file")
    get.add_argument("-output_bam", metavar = "output_bam", default = None, type = str, help = "Output bam")
    ...
    annot.add_argument("-input_file", metavar = "input_file", default = None, type = str, help = "Input file(such as juncmut.txt generated by juncmut)")
    annot.add_argument("-output_file", metavar = "output_file", default = "juncmut.txt", type = str, help = "Output file")
    annot.add_argument("-reference", metavar = "reference", default = None, type = str, help = "Path to reference genome")
    annot.add_argument("-gnomad", metavar = "gnomad", default = None, type = str, help = "Path to gnomad vcf file")
    ...
    validate.add_argument("-input_file", metavar = "input_file", default = None, type = str, help = "Input file obtained by the juncmut get")
    validate.add_argument("-output_file", metavar = "output_file", default = "juncmut.val.txt", type = str, help = "Output file")
    validate.add_argument("-reference", metavar = "reference", default = None, type = str, help = "Path to reference genome")
    validate.add_argument("-dna_bam", metavar = "dna_bam", default = None, type = str, help = "Path to DNA bam file")
